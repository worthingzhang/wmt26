...
LOG_FILE="${LOG_DIR}/probe4096.log"
mkdir -p "${LOG_DIR}"

FORCE_TORCHRUN=1 llamafactory-cli train /home/zc/wmt26/configs/train/cpt/cpt_v1_official_plaintext_dsb4x_probe4096.yaml 2>&1 | tee "${LOG_FILE}"
