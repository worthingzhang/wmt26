"""Local utility module for WMT26 Sorbian devsplit few-shot v2 overlay tasks.

This module provides shot-loading helpers used by the overlay YAMLs under
``configs/eval/tasks/wmt26_sorbian_devsplit_fewshot_v2/``.  Each subdirectory
...
_SHOTS_DIR = Path("/home/zc/wmt26/configs/eval/devsplits/sorbian_devsplit_fewshot_v2/shots")
